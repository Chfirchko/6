note
	description: "Barber application root class"
	date: "$Date$"
	revision: "$Revision$"
	...
	make
		...
		do
			...
			if attached temp_str as l_temp_str then
				...
				print ("Number of cash desk: " + cash_desks_num.out +
					"%N")
				print ("Number of barbers: " + barbers_num.out + "%N")
				print ("Number of customers: " + customer_num.out +
					"%N")
				print ("Number of haircuts per customer: " +
					haircuts.out + "%N")
				print ("Number of waiting sits on sofa : " +
					sofa_size.out + "%N")
				print ("Number of waiting place in standing room :" +
					waiting_room_size.out + "%N")
				print ("%N")
				...
				across (1 |..| customer_num) as ic loop
					...
					create customer.make (ic.item, haircuts, shop,
						sofa, barbers, cash_desk)
